...
import com.lex.LexCommerce.dto.ValidationError;
...
public class ControllerExcepetionHandler {
    ...
    public ResponseEntity<ErroCustomizado> metodoInvalido(MethodArgumentNotValidException e, HttpServletRequest request) {
